                    ...
                    <Row center className={classes.credentials}>
                        ...
                        <Col>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', flexDirection: 'row' }}>
                                {
                                    credentials.spotifyUsername.length > 0 &&
                                    <a href={`https://open.spotify.com/user/${credentials.spotifyUsername}`}>
                                        <img style={{ marginTop: '10px', width: '35px', height: '35px', marginRight: '10px' }} src={require('../../assets/images/spotify.png')} alt="spotify-photo"></img>
                                    </a>
                                }
                                {
                                    credentials.instagramUsername.length > 0 &&
                                    <a href={`https://www.instagram.com/${credentials.instagramUsername}`}>
                                        <img style={{ marginTop: '10px', width: '35px', height: '35px', marginRight: '10px' }} src={require('../../assets/images/instagram.png')} alt="instagram-png"></img>
                                    </a>
                                }
                                {
                                    credentials.twitterUsername.length > 0 &&
                                    <a href={`https://www.twitter.com/${credentials.twitterUsername}`}>
                                        <img style={{ marginTop: '10px', width: '35px', height: '35px' }} src={require('../../assets/images/twitter.png')} alt="twitter-png"></img>
                                    </a>
                                }
                            </div>
                        </Col>
