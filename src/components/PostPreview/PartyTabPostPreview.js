...
const PartyTabPostPreview = (props) => {
                        ...
                        <CardBody>
                            <Row>
                                <Col style={{textAlign: 'center'}}>
                                    <img style={{width: '100%', height: '300px', objectFit: 'cover', borderRadius: '10px'}} src={post.party_photo} alt=""></img>
                                </Col>
                            </Row>
                            <Row style={{marginTop: '20px'}}>
                                <Col>
                                    <h1>{post.produced_id.name}</h1>
                                </Col>
                            </Row>
                            {
                                post.tur === "Party" &&
                            ...
                            <Row start style={{marginLeft: '5px', marginBottom: '-15px'}}>
                                ...
                                <Col xs="2">
                                    <a href={`/profile/${post.produced_id.username}`}><p>{`@${post.produced_id.username}`}</p></a>
                                </Col>
                            </Row>
                            <hr></hr>
...
export default PartyTabPostPreview;